package com.bootrcamp.capstone.prsdb.product;

import javax.persistence.*;

import com.bootrcamp.capstone.prsdb.vendor.Vendor;

@Entity
@Table(name="Products", uniqueConstraints=@UniqueConstraint(columnNames={"partNbr"}))
